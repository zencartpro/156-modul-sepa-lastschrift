 ...
 * @version $Id: tpl_checkout_payment_default.php for SEPA Lastschrift 2020-07-28 14:59:42Z webchills $
 */
?>
...
<?php } elseif (($selection[$i]['id']) == 'sepalastschrift') {  ?>
    <div class="ccinfosepa">
<?php } elseif (($selection[$i]['id']) == 'sepalastschrifteu') {  ?>
	<div class="ccinfosepaeu">
<?php	} else {	?>
		<div class="ccinfo">
<?php } ?>
<?php
